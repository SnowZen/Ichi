...
export function UnoCard({ 
  ...
  const colorClasses = {
    ...
    green: 'bg-gradient-to-br from-green-500 to-green-600 border-green-700 shadow-green-500/25',
    yellow: 'bg-gradient-to-br from-yellow-400 to-yellow-500 border-yellow-600 shadow-yellow-500/25',
  ...
  const getCardContent = () => {
    ...
    if (card.type === 'wild_draw4') return (
      <div className="flex flex-col items-center justify-center h-full">
